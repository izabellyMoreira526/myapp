  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 145, 211, 245)), // Gera um esquema de cores baseado na cor deepPurple.
        useMaterial3: true, // Ativa o estilo Material Design 3.
      ),
      home: const MyHomePage(title: 'Primeiro Projeto no Flutter'), // Define a página inicial do aplicativo.
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text(
              ...
              'Programa participativo do flutter, clique no + para incrementar o placar'
            ),
            Text(
